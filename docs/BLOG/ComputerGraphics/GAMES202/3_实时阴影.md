...
VSSM 中不进行该区域的循环遍历，不进行加权平均的计算，而是直接通过 VSSM 的基本思想——切比雪夫不等式近似获得该区域比当前深度值t小的点占总数的**比例 ​**​$ratio$，则当前点的可见性即为 $V \cdot ratio$
...
![VSSM 的漏光现象 Light Leaking](assets/image-20230705142634-s7s8m3w.png "VSSM 的漏光现象 Light Leaking")
<div align=center>
